  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (err instanceof Error) {
        ...
        setError("Something went wrong while creating your trip. Please try again.");
      }
    } finally {
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div className="flex-1">
            <h1 className="text-3xl font-bold text-gray-900 mb-1">Create Your Next Adventure</h1>
            <p className="text-gray-600">Plan something amazing with friends and family</p>
          </div>
              ...
              <CardContent className="p-8">
                <form onSubmit={handleSubmit} className="space-y-8">
                  ...
                  <div className="space-y-3">
                    <Label htmlFor="title" className="text-base font-medium text-gray-900 flex items-center gap-2">
                  ...
                  <div className="space-y-3">
                    ...
                    <Textarea
                      ...
                      rows={5}
                      className={`text-base resize-none ${errors.description ? 'border-red-500 focus:border-red-500' : ''}`}
                      disabled={isSubmitting}
                      maxLength={500}
                    />
                    <div className="flex justify-between items-start">
                      <div className="space-y-1">
                        ...
                        {!errors.description && formData.description && formData.description.length >= 10 && (
                          <div className="flex items-center gap-2 text-green-600 text-sm">
                            <CheckCircle className="h-4 w-4" />
                            Perfect description!
                          </div>
              ...
              <CardContent className="p-6">
                <div className="space-y-3 text-sm text-amber-800">
                  <div className="flex items-start gap-2">
                    ...
                    <span>Use descriptive titles to make your trip memorable</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <div className="w-1.5 h-1.5 rounded-full bg-amber-500 mt-2 flex-shrink-0"></div>
                    <span>Include everyone who might join in your description</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <div className="w-1.5 h-1.5 rounded-full bg-amber-500 mt-2 flex-shrink-0"></div>
